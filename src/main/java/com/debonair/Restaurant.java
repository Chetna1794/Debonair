...
/**
 * Restaurant class is the main class which drives the complete program
 * 
 * @author Chetna
 * @since 08-Apr-2020
 */
public class Restaurant implements IRestaurant {
	 ...
	 * @return True, if the order is present in the queue <br>
	 * 			False, if the order is not present in the queue
	 * @since 08-Apr-2020
	 */
	 ...
	 * 
	 * @param customerId Regular Customer Id
	 *  
	 * @since 08-Apr-2020
	 */
	 ...
	 * 
	 * @param corporateId Corporate Customer ID
	 * @since 08-Apr-2020
	 */
	...
	public static void main(String[] args) {
		...
		int choice;
		do {
			// console driven menu for the com.debonair.customer
			...
			System.out.println("4. Show Regular com.debonair.customer Offers");
